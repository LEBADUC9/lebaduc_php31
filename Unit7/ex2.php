<?php
    ...
    function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->Username   = "duclb.php@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "ducabc123@@@"; //Mật khẩu của gmail
        $mail->SetFrom("duc9999999991@gmail.com", "Lê B.Đức"); // Thông tin người gửi
        $mail->AddReplyTo("duc9999999991@gmail.com","Lê B.Đức");// Ấn định email sẽ nhận khi người dùng reply lại.
    ...
    $subject = "Hí";
    $contents = "hihi";
    send_email("duclb.php@gmail.com", "Đức", $contents, $subject);
?>